...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddSingleton<ICameraSnapshotService, CameraSnapshotService>();
        builder.Services.AddScoped<IEntryCameraService, EntryCameraService>();
        builder.Services.AddScoped<IVehicleRecognitionAiService, OpenAiVehicleRecognitionService>();
        builder.Services.AddScoped<ICameraAiRfidAccessService, CameraAiRfidAccessService>();
        ...
        builder.Services.AddSingleton<ISmartParkingRouteService, SmartParkingRouteService>();
        ...
        _ = app.Services.GetRequiredService<ISmartParkingRouteService>();
